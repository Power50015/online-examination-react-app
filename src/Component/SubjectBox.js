...
export default function SubjectBox() {
  ...
  return (
    <div className="bg-[#09103a] text-white px-4 py-4 rounded-lg mb-4">
      <h2 className="text-[#3281c0] font-bold text-5xl mb-5">{count}</h2>
      ...
      <div className="w-full text-center my-5 flex flex-col">
        <Link
          to="/create-subjects"
          className="mb-4 rounded-lg px-4 py-2 border-2 border-blue-500 text-blue-500 hover:bg-blue-600 hover:text-blue-100 duration-300"
        >
          إضافه مادة
        </Link>
        <Link
